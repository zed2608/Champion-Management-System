...
class TaggingView(ctk.CTkFrame):
    ...
    def build_main_panel(self):
        ...
        self.search_entry = ctk.CTkEntry(
            search_frame, placeholder_text="Universal Search (PID, Name, Cat, Sup, Tag)...", width=350, textvariable=self.search_var)
        ...
        self.filter_menu = ctk.CTkOptionMenu(search_frame, values=[
                                             "All Tools", "Needs Tag", "Already Tagged"], width=140, fg_color="#F9FAFB", text_color="black", command=lambda e: self.perform_search())
        ...
        self.headers = ["PID", "Name", "Category",
                        "Supplier", "Qty", "Location", "Status", "Tag ID"]
    ...
    def load_tagging_data(self, query="", filter_type="All Tools"):
        ...
        loading_lbl = ctk.CTkLabel(table_inner, text="↻ Loading data... Please wait",
        ...
        def _fetch():
            ...
            try:
                ...
                self.after(0, lambda: self._render_tagging_data(
                    results, table_inner, loading_lbl, min_sizes))
            except Exception as e:
                self.after(0, lambda err=e: loading_lbl.configure(
                    text=f"Failed to load tags: {err}", text_color="red"))
            finally:
    ...
    def _render_tagging_data(self, results, table_inner, loading_lbl, min_sizes):
        ...
        for i, row_data in enumerate(results):
            ...
            display_data = [str(tool_id), str(name), str(cat), str(
                sup), str(qty), str(loc), str(cond), str(tag)]
            full_data = [tool_id, name, desc, price,
                         qty, loc, cond, tag, cat, sup]
        ...
        def update_preview():
            ...
            def execute_print():
                try:
                    ...
                    draw.text((text_x, text_y), text_str,
            ...
            ctk.CTkButton(preview_frame, text="⎙ Generate Print File", width=140, height=35, fg_color="#1E4528",
